...
class SubmodelElement(
    base.Referable, base.Qualifiable, base.HasSemantics, base.HasDataSpecification, metaclass=abc.ABCMeta
):
    """
    ...
    **Constraint AASd-014:** Either the attribute ``globalAssetId`` or ``specificAssetId`` of an ``Entity``
    ...
    def _check_constraint_set_spec_asset_id(
        ...
        self._validate_aasd_014(
            self.entity_type, self.global_asset_id, len(old_list) - len(items_to_replace) + len(new_items) > 0
        )
...
class BasicEventElement(EventElement):
    ...
    def __init__(
        ...
        message_broker: Optional[
            base.ModelReference[Union[Submodel, SubmodelElementList, SubmodelElementCollection, Entity]]
        ] = None,
