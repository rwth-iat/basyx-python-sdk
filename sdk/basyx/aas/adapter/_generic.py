...
DIRECTION: Dict[model.Direction, str] = {model.Direction.INPUT: "input", model.Direction.OUTPUT: "output"}

STATE_OF_EVENT: Dict[model.StateOfEvent, str] = {model.StateOfEvent.ON: "on", model.StateOfEvent.OFF: "off"}
...
IEC61360_LEVEL_TYPES_INVERSE: Dict[str, model.base.IEC61360LevelType] = {v: k for k, v in IEC61360_LEVEL_TYPES.items()}
