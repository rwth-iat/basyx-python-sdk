...
class AASToJsonEncoder(json.JSONEncoder):
    ...
    @classmethod
    def _data_specification_iec61360_to_json(cls, obj: model.base.DataSpecificationIEC61360) -> Dict[str, object]:
        """
        ...
        :return: dict with the serialized attributes of this object
        """
        data_spec: Dict[str, object] = {"modelType": "DataSpecificationIec61360", "preferredName": obj.preferred_name}
...
def _create_dict(
    data: model.AbstractObjectStore, keys_to_types: Iterable[Tuple[str, Type]] = JSON_AAS_TOP_LEVEL_KEYS_TO_TYPES
...
def object_store_to_json(
    data: model.AbstractObjectStore, stripped: bool = False, encoder: Optional[Type[AASToJsonEncoder]] = None, **kwargs
) -> str:
    """
