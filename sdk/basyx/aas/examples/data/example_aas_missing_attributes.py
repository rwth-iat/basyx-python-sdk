...
def create_example_submodel() -> model.Submodel:
    ...
    qualifier = model.Qualifier(
        type_="http://example.org/Qualifier/ExampleQualifier", value_type=model.datatypes.String
    )
    ...
    asset_administration_shell = model.AssetAdministrationShell(
        ...
        submodel={
            model.ModelReference(
                (model.Key(type_=model.KeyTypes.SUBMODEL, value="https://example.org/Test_Submodel_Missing"),),
                model.Submodel,
            )
        },
        derived_from=None,
