    ...
    data_specification=model.ExternalReference(
        (
            model.Key(
                ...
                value="https://admin-shell.io/DataSpecificationTemplates/DataSpecificationIEC61360/3/1",
            ),
        )
    ),
    data_specification_content=model.DataSpecificationIEC61360(
        preferred_name=model.PreferredNameTypeIEC61360({"de": "Test Specification", "en-US": "TestSpecification"}),
        ...
        unit_id=model.ExternalReference(
            (model.Key(type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://example.org/Units/SpaceUnit"),)
        ),
        ...
        value_list={
            model.ValueReferencePair(
                ...
                value_id=model.ExternalReference(
                    (
                        model.Key(
                            type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://example.org/ValueId/ExampleValueId"
                        ),
                    )
                ),
            ),
            model.ValueReferencePair(
                ...
                value_id=model.ExternalReference(
                    (
                        model.Key(
                            type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://example.org/ValueId/ExampleValueId2"
                        ),
                    )
                ),
            ),
...
def create_example_asset_identification_submodel() -> model.Submodel:
    ...
    qualifier = model.Qualifier(
        ...
        value=100,
        value_id=model.ExternalReference(
            (model.Key(type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://example.org/ValueId/ExampleValueId"),)
        ),
    ...
    identification_submodel = model.Submodel(
        ...
        administration=model.AdministrativeInformation(
            ...
            template_id="http://example.org/AdministrativeInformationTemplates/TestAsset/Identification",
        ),
        semantic_id=model.ModelReference(
            (
                model.Key(
                    type_=model.KeyTypes.SUBMODEL, value="http://example.org/SubmodelTemplates/AssetIdentification"
                ),
            ),
            model.Submodel,
        ),
...
def create_example_bill_of_material_submodel() -> model.Submodel:
    ...
    submodel_element_property = model.Property(
        ...
        parent=None,
        semantic_id=model.ExternalReference(
            (model.Key(type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://example.org/Properties/ExampleProperty"),)
        ),
        qualifier=(),
        extension=(),
        supplemental_semantic_id=(),
        ...
        specific_asset_id={
            model.SpecificAssetId(
                ...
                external_subject_id=model.ExternalReference(
                    (model.Key(type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://example.org/SpecificAssetId/"),)
                ),
            )
        },
        category="PARAMETER",
    ...
    bill_of_material = model.Submodel(
        ...
        parent=None,
        administration=model.AdministrativeInformation(
            version="9", template_id="http://example.org/AdministrativeInformationTemplates/TestAsset/BillOfMaterial"
        ),
        semantic_id=model.ModelReference(
            (model.Key(type_=model.KeyTypes.SUBMODEL, value="http://example.org/SubmodelTemplates/BillOfMaterial"),),
            model.Submodel,
        ),
        qualifier=(),
        kind=model.ModellingKind.INSTANCE,
...
def create_example_submodel() -> model.Submodel:
    ...
    submodel_element_property = model.Property(
        ...
        display_name=model.MultiLanguageNameType({"en-US": "ExampleProperty", "de": "BeispielProperty"}),
        category="CONSTANT",
        description=model.MultiLanguageTextType(
            {"en-US": "Example Property object", "de": "Beispiel Property Element"}
        ),
    ...
    submodel_element_multi_language_property = model.MultiLanguageProperty(
        ...
        category="CONSTANT",
        description=model.MultiLanguageTextType(
            {"en-US": "Example MultiLanguageProperty object", "de": "Beispiel MultiLanguageProperty Element"}
        ),
        parent=None,
        semantic_id=model.ExternalReference(
            (
    ...
    submodel_element_range = model.Range(
        ...
        max=100,
        category="PARAMETER",
        description=model.MultiLanguageTextType({"en-US": "Example Range object", "de": "Beispiel Range Element"}),
        parent=None,
        semantic_id=model.ExternalReference(
            (model.Key(type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://example.org/Ranges/ExampleRange"),)
        ),
        qualifier=(),
        extension=(),
        supplemental_semantic_id=(),
    ...
    submodel_element_blob = model.Blob(
        ...
        category="PARAMETER",
        description=model.MultiLanguageTextType({"en-US": "Example Blob object", "de": "Beispiel Blob Element"}),
        parent=None,
        semantic_id=model.ExternalReference(
            (model.Key(type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://example.org/Blobs/ExampleBlob"),)
        ),
        qualifier=(),
        extension=(),
        supplemental_semantic_id=(),
    ...
    submodel_element_file = model.File(
        ...
        value="/TestFile.pdf",
        category="PARAMETER",
        description=model.MultiLanguageTextType({"en-US": "Example File object", "de": "Beispiel File Element"}),
        parent=None,
        semantic_id=model.ExternalReference(
            (model.Key(type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://example.org/Files/ExampleFile"),)
        ),
        qualifier=(),
        extension=(),
        supplemental_semantic_id=(),
    ...
    submodel_element_reference_element = model.ReferenceElement(
        ...
        category="PARAMETER",
        description=model.MultiLanguageTextType(
            {"en-US": "Example Reference Element object", "de": "Beispiel Reference Element Element"}
        ),
        parent=None,
        semantic_id=model.ExternalReference(
            (
    ...
    submodel_element_relationship_element = model.RelationshipElement(
        ...
        category="PARAMETER",
        description=model.MultiLanguageTextType(
            {"en-US": "Example RelationshipElement object", "de": "Beispiel RelationshipElement Element"}
        ),
        parent=None,
        semantic_id=model.ModelReference(
            (model.Key(type_=model.KeyTypes.CONCEPT_DESCRIPTION, value="https://example.org/Test_ConceptDescription"),),
    ...
    input_variable_property = model.Property(
        ...
        semantic_id=model.ExternalReference(
            (
                model.Key(
                    type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://example.org/Properties/ExamplePropertyInput"
                ),
            )
        ),
        qualifier=(),
    ...
    output_variable_property = model.Property(
        ...
        semantic_id=model.ExternalReference(
            (
                model.Key(
                    type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://example.org/Properties/ExamplePropertyOutput"
                ),
            )
        ),
        qualifier=(),
    ...
    in_output_variable_property = model.Property(
        ...
        semantic_id=model.ExternalReference(
            (
                model.Key(
                    type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://example.org/Properties/ExamplePropertyInOutput"
                ),
            )
        ),
        qualifier=(),
    ...
    submodel_element_operation = model.Operation(
        ...
        parent=None,
        semantic_id=model.ExternalReference(
            (model.Key(type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://example.org/Operations/ExampleOperation"),)
        ),
        qualifier=(),
        extension=(),
        supplemental_semantic_id=(),
    ...
    submodel_element_capability = model.Capability(
        ...
        semantic_id=model.ExternalReference(
            (
                model.Key(
                    type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://example.org/Capabilities/ExampleCapability"
                ),
            )
        ),
        qualifier=(),
    ...
    submodel_element_basic_event_element = model.BasicEventElement(
        ...
        message_broker=model.ModelReference(
            (model.Key(model.KeyTypes.SUBMODEL, "http://example.org/ExampleMessageBroker"),), model.Submodel
        ),
        ...
        category="PARAMETER",
        description=model.MultiLanguageTextType(
            {"en-US": "Example BasicEventElement object", "de": "Beispiel BasicEventElement Element"}
        ),
        parent=None,
        semantic_id=model.ExternalReference(
            (
                model.Key(
                    type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://example.org/Events/ExampleBasicEventElement"
                ),
            )
        ),
        qualifier=(),
    ...
    submodel_element_submodel_element_list = model.SubmodelElementList(
        ...
        category="PARAMETER",
        description=model.MultiLanguageTextType(
            {"en-US": "Example SubmodelElementList object", "de": "Beispiel SubmodelElementList Element"}
        ),
        parent=None,
        semantic_id=model.ExternalReference(
            (
    ...
    submodel_element_submodel_element_collection = model.SubmodelElementCollection(
        ...
        category="PARAMETER",
        description=model.MultiLanguageTextType(
            {"en-US": "Example SubmodelElementCollection object", "de": "Beispiel SubmodelElementCollection Element"}
        ),
        parent=None,
        semantic_id=model.ExternalReference(
            (
    ...
    submodel = model.Submodel(
        ...
        administration=model.AdministrativeInformation(
            ...
            creator=model.ExternalReference(
                (
                    model.Key(
                        model.KeyTypes.GLOBAL_REFERENCE, "http://example.org/AdministrativeInformation/Test_Submodel"
                    ),
                )
            ),
        ),
        semantic_id=model.ExternalReference(
            (
                model.Key(
                    type_=model.KeyTypes.GLOBAL_REFERENCE, value="http://example.org/SubmodelTemplates/ExampleSubmodel"
                ),
            )
        ),
        qualifier=(),
...
def create_example_concept_description() -> model.ConceptDescription:
    ...
    concept_description = model.ConceptDescription(
        ...
        administration=model.AdministrativeInformation(
            ...
            template_id="http://example.org/AdministrativeInformationTemplates/Test_ConceptDescription",
            embedded_data_specifications=(_embedded_data_specification_iec61360,),
        ),
    )
...
def create_example_asset_administration_shell() -> model.AssetAdministrationShell:
    ...
    asset_information = model.AssetInformation(
        ...
        specific_asset_id={
            model.SpecificAssetId(
                ...
                semantic_id=model.ExternalReference(
                    (model.Key(model.KeyTypes.GLOBAL_REFERENCE, "http://example.org/SpecificAssetId/"),)
                ),
            )
        },
    ...
    asset_administration_shell = model.AssetAdministrationShell(
        ...
        administration=model.AdministrativeInformation(
            ...
            template_id="http://example.org/AdministrativeInformationTemplates/Test_AssetAdministrationShell",
        ),
        submodel={
            model.ModelReference(
                (model.Key(type_=model.KeyTypes.SUBMODEL, value="https://example.org/Test_Submodel"),),
                model.Submodel,
                model.ExternalReference(
                    (
                        model.Key(
