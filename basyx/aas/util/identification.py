...
class AbstractIdentifierGenerator(metaclass=abc.ABCMeta):
    """
    Abstract base class for identifier generators that generate identifiers
    ...
    """
    @abc.abstractmethod
    def generate_id(self, proposal: Optional[str] = None) -> str:
        """
...
class NamespaceIRIGenerator(AbstractIdentifierGenerator):
    ...
    Identifiers are generated by concatenating a fixed namespace
